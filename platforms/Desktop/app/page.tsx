...
export default function Home() {
  const { passwords, addPassword, updatePassword, deletePassword, user } = usePasswords()
  ...
  return (
    <main className="ak-app min-h-screen p-4 text-[#2d2754] sm:p-7">
      ...
      {modal === 'password' && <PasswordModal isOpen onClose={close} onSave={savePassword} editPassword={editing} />}
