  ...
  return (
    <main className="ak-app min-h-screen p-4 text-[#2d2754] sm:p-7">
      <div className="mx-auto max-w-7xl">
        ...
        {section === 'passwords' && <PasswordsWorkspace passwords={passwords} categories={categories} onCreateCategory={addCategory} onNew={() => open('password')} onEdit={(password) => open('password', password)} onDetail={setSelectedPassword} onDelete={deletePassword} />}
