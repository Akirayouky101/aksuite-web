...
const statusColors = {
  ...
  'in-progress': { bg: 'bg-blue-500/20', border: 'border-teal-500/30', text: 'text-teal-300' },
...
export default function TasksListModal({ isOpen, onClose, tasks, onDelete, onToggleComplete, onUpdate, onAdd }: TasksListModalProps) {
  ...
  return (
    <>
      <AnimatePresence>
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-x-hidden">
          <motion.div
            ...
            <div className="relative bg-[#131920] rounded-2xl max-h-[90vh] overflow-hidden border border-white/[0.08] shadow-2xl">
              ...
              <div className="flex items-center justify-between p-6 border-b border-white/10 bg-gradient-to-r from-purple-900/30 to-pink-900/30">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/40">{tasks.length} task registrati</p>
                  </div>
                </div>
                <button
                  onClick={onClose}
              ...
              <div className="p-4 border-b border-white/10 bg-white/[0.03] space-y-2">
                <button
                  ...
                  className="w-full px-4 py-3 rounded-lg font-bold text-base transition-all bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-green-700 hover:to-emerald-700 text-white shadow-lg shadow-green-500/30 flex items-center justify-center gap-2"
                >
              ...
              {/* Dashboard */}
              {showDashboard && (
                <div className="p-6 border-b border-white/10 bg-white/[0.04]/30">
              ...
              <div className="p-4 border-b border-white/10 bg-white/[0.03] space-y-3">
                <div className="grid grid-cols-2 md:grid-cols-5 gap-2">
                  ...
                  <select
                    ...
                    className="px-3 py-2 bg-white/[0.06] text-white rounded-lg border border-white/[0.08] focus:border-pink-500 focus:outline-none text-sm"
                  >
                          ...
                          <div className="flex items-start justify-between gap-4">
                            <div className="flex items-start gap-3 flex-1">
                              ...
                              >
                                {task.is_completed ? (
                                  ...
                                  <Circle className="w-6 h-6 text-white/30 hover:text-white/50" />
                                )}
                              </button>
                              ...
                              <div className="flex-1 space-y-3">
                                ...
                                <div className="flex items-start gap-3">
                                  ...
                                  <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                                      <h3 className={`text-xl font-bold ${task.is_completed ? 'text-white/30 line-through' : 'text-white'}`}>
                                        {task.title}
                                      </h3>
                                ...
                                {/* Due Date */}
                                {task.due_date && (
                                  <div className={`flex items-center gap-2 text-sm ${overdue ? 'text-red-300' : 'text-white/50'}`}>
                            ...
                            <div className="flex flex-col gap-2">
                              <button
                                ...
                                className="p-2 bg-blue-500/20 hover:bg-blue-500/30 border border-teal-500/30 rounded-lg transition-colors"
                                title="Modifica"
                              >
