          ...
          <div className="relative bg-white rounded-2xl overflow-hidden border border-slate-200 shadow-2xl">
            ...
            <div className="flex items-center justify-between p-6 border-b border-slate-200 bg-gradient-to-r from-indigo-50 to-indigo-50">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-slate-800">Registro Chiamate</h2>
            ...
            {/* Dashboard */}
            {showDashboard && (
              <div className="p-6 border-b border-slate-200 bg-slate-50 max-h-96 overflow-y-auto">
            ...
            <div className="p-4 border-b border-slate-200 bg-white space-y-3">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                ...
                <select
                  ...
                  className="px-3 py-2 bg-slate-50 text-slate-800 rounded-lg border border-slate-200 focus:border-indigo-400 focus:outline-none text-sm flex items-center gap-2"
                >
                ...
                <button
                  ...
                  className={`px-3 py-2 rounded-lg font-semibold text-sm transition-all flex items-center justify-center gap-2 ${
                    showFollowUpOnly
                      ? 'bg-gradient-to-r from-orange-500 to-red-500 text-slate-800'
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1 flex-wrap">
                                  <h3 className="text-xl font-bold text-slate-800">{call.caller_name}</h3>
